...
// Code to display dental hygienist table in appointments.
public class DentalHygienistServlet extends HttpServlet{
    
    // Method that fetches table data for dental hygienists.
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // JSON array to hold data.
        JSONArray jsonArray = new JSONArray();

        // Query
        String query = "SELECT * FROM dental_hygienist ORDER BY last_name ASC";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                jsonObject.put("dentalHygienistId", rs.getString("dental_hygienist_id"));

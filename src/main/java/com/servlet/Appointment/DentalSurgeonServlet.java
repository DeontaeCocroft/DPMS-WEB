...
// Code that displays dental surgeon table in appointments.
public class DentalSurgeonServlet extends HttpServlet {
    
    // Method that fetches table data for dental surgeons.
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // JSON array to hold data.
        JSONArray jsonArray = new JSONArray();

        // Query
        String query = "SELECT * FROM dental_surgeon ORDER BY last_name ASC";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                jsonObject.put("dentalSurgeonId", rs.getString("dental_surgeon_id"));
